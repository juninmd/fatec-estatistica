    ...
    public class ColunaTabelaDistribuicao
    {
        ...
        public decimal GetLinha()
        {
            ...
            if (ValorColuna == new decimal(2.2))
                return GetValorLinha(F(4861), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            ...
            if (ValorColuna == new decimal(2.4))
                return GetValorLinha(F(4918), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(2.5))
                return GetValorLinha(F(4938), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(2.6))
                return GetValorLinha(F(4953), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(2.7))
                return GetValorLinha(F(4965), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(2.8))
                return GetValorLinha(F(4974), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(2.9))
                return GetValorLinha(F(4981), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
            if (ValorColuna == new decimal(3.0))
                return GetValorLinha(F(4987), F(0438), F(), F(), F(), F(), F(), F(), F(), F());
